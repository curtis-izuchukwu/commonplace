...
import com.pararepilot.importer.ExtractedPdfImage;
import com.pararepilot.importer.ImportIssue;
import com.pararepilot.importer.ImportedQuestionDraft;
import com.pararepilot.importer.ImportedWorksheetDraft;
import com.pararepilot.importer.PdfImportService;
...
import com.pararepilot.service.StudyStructureService;
    ...
    private void populateReview(ImportedWorksheetDraft draft) {
        ...
        if (draft.issues().isEmpty()) {
            addIssue(new ImportIssue(
                    com.pararepilot.importer.ImportIssueSeverity.INFO,
