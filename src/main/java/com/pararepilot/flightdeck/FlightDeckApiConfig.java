...
public final class FlightDeckApiConfig {
    ...
    public static final String BASE_URL_PROPERTY = "pararepilot.flightdeck.baseUrl";
    public static final String BASE_URL_ENV = "PARAREPILOT_FLIGHTDECK_API_BASE_URL";
