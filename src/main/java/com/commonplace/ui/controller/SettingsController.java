...
import com.commonplace.repository.UserStatsRepository;
import com.commonplace.service.DataManagementService;
import com.commonplace.service.UserSettingsService;
import com.commonplace.ui.AppIcon;
import com.commonplace.ui.AppPreferences;
...
public class SettingsController {
    ...
    private void handleChangePassword() {
        try {
            OverlayService.open(settingsRoot, "/com/commonplace/fxml/ChangePasswordView.fxml", 520, 430);
        } catch (IOException e) {
    ...
    private void handleExportData() {
        ...
        chooser.setTitle("Export Commonplace Backup");
        chooser.getExtensionFilters().add(new FileChooser.ExtensionFilter("SQLite backup", "*.db"));
        chooser.setInitialFileName("commonplace-backup.db");
    ...
    private void handleImportBackup() {
        FileChooser chooser = new FileChooser();
        chooser.setTitle("Import Commonplace Backup");
        chooser.getExtensionFilters().add(new FileChooser.ExtensionFilter("SQLite backup", "*.db"));
